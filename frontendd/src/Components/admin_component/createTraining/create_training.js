...
export default function Admin_training() {
    ...
    return (
        <>
            <h1 className='headings'>Learning and Development</h1>
                                ...
                                <div className="row">
                                    <div className="col-lg-4">
                                        <div className="card cards">
                                            ...
                                            <p className='card-text'>"Effortlessly create and customize training sessions for your team's growth and development needs. Tailor these sessions to address specific skills, knowledge gaps, and professional aim and goals. "</p>                                                
                                    ...
                                    <div className="col-lg-4">
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                            <p className='card-text'>"Easily view and manage scheduled training sessions to keep your team's learning on track. Streamline communication, track progress, and adapt to evolving needs with our intuitive platform."</p>
                                                <View_training />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-4">
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                            <p className='card-text'>"Effortlessly access deleted training records and perform resets for seamless course management. Ensure data integrity and maintain accurate training histories with ease, enhancing your organizations."</p>
                                                <Archieve />
                                            </div>
                                        </div>
                                    </div>
